...
class HttpClient {
  ...
  HttpClient({this.quic = true}):_cronet_engine = _cronet.Cronet_Engine_Create(){
  ...
  String get HttpClientVersion => _cronet.Cronet_Engine_GetVersionString(_cronet_engine).cast<Utf8>().toDartString();
}